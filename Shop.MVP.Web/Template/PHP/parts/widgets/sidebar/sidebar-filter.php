	        ...
	        <div class="accordion-group">
	            ...
	            <div class="accordion-body collapse" id="collapseOne">
	                <div class="accordion-inner">
						...
						<p class="slider-price-range"><input type="text" id="amount"></p>
	                </div><!-- /.accordion-inner -->
	            </div><!-- /.accordion-body -->
	        </div><!-- /.accordion-group -->
	                ...
	                <div class="accordion-inner">
                    	<div class="color-holder clearfix">							
							<ul class="color-picker clearfix">
								<li><input class="le-radio blue checked" type="radio" value="color1" name="sidebar" checked="checked"></li>
								<li><input class="le-radio gray" type="radio" value="color2" name="sidebar"></li>
								<li><input class="le-radio red" type="radio" value="color3" name="sidebar"></li>
								<li><input class="le-radio green" type="radio" value="color4" name="sidebar"></li>
								<li><input class="le-radio" type="radio" value="color5" name="sidebar"></li>
							</ul><!-- /.color-picker -->
						</div><!-- /.color-holder -->
	                </div><!-- /.accordion-inner -->
	            </div><!-- /.accordion-body -->
