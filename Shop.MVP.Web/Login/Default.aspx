    ...
    <div class="container">
        ...
        <section class="billing-address col-md-6">
            ...
            <div class="billing-address-form">
                ...
                <asp:Panel runat="server" ID="pnlNewsletterSubscription" class="form-group checkbox">
                    <label>
                        <asp:CheckBox runat="server" ID="cbNewsletterSubscription" />
                        ...
                        <asp:CompleteWizardStep runat="server">
                            <ContentTemplate>
                                <span style="color: seagreen;">L'account è stato creato con successo.<br />
                                    Ti abbiamo inviato una e-mail con i dati del tuo account. <b>Benvenuto in Calzafacile!</b></span>
                            </ContentTemplate>
