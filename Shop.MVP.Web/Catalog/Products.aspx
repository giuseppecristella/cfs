            ...
            <div class="row row-no-margin">
                <div class="col-md-9 col-sm-10">
                    ...
                    <div class="catalog-products clearfix">
                        <div ng-repeat="product in catalog | filter: my.favorite |  filter: filterFunction | filter: filterPrice | filter: filterByColors" class='col-md-6 col-sm-6 col-lg-4 col-xs-12 product-holder'>
                            <div class="product">
                                <div class="image">
