...
<section class="contact-form container ">
	<div class="row">
		<div class="col-md-10 center-block">
            ...
            <p>I tempi di consegna sono espressi in giorni lavorativi e partono dalla data dell’ordine (sabato, domenica e festivi esclusi). Per problemi dettati da cause di forza maggiore, CalzaFacile.it non potrà essere considerata responsabile del ritardo nelle consegne.

</i></p>
		

   <h3 class="form-title">2 Soddisfatti o rimborsati

</h3>
            <p>Tutti gli articoli acquistati sul sito CALZAFACILE.IT possono essere oggetto di un cambio o di un rimborso. Per essere accettati, i resi devono rispettare le seguenti condizioni:
...
- Il prodotto deve essere reso nei 7 giorni che seguono il ricevimento dell’ordine.
   ...
   <h4 class="form-title">2.2 : La procedura di reso è la seguente:

</h4><p>Tutti gli articoli acquistati sul sito CALZAFACILE.IT possono essere oggetto di un cambio o di un rimborso.
...
Il reso del o degli articoli deve imperativamente seguire la procedura qui sotto indicata:
   ...
   <h3 class="form-title">Fase 1: Scheda cliente
</h3><p>
Collegarsi alla propria Scheda cliente nel sito CALZAFACILE.IT con il proprio indirizzo email e password ed accedere inoltrando una mail ad info@calzafacile.it 
    ...
    <h4 class="form-title">Fase 2: Stampare l’etichetta
</h4>
            <p>- Se il reso è offerto da CalzaFacile.it: sarà inviata al cliente una e-mail con un link per stampare un'etichetta prepagata.
- Se il reso è a carico del cliente: sarà inviata una e-mail con l’indirizzo al quale dovrà essere rinviata la merce a carico del cliente.
  ...
  <h4 class="form-title">Fase 3: Ritiro o invio del pacco

</h4>
            <p> Se il reso è offerto da CalzaFacile.it: Il cliente dovrà contattare il corriere al numero indicato nella e-mail e mettersi d’accordo con loro per un appuntamento per il ritiro della merce a domicilio.
...
Il reso viene trattato in 7/10 giorni lavorativi.
    ...
    <h3 class="form-title">3 Trattamento dei colli non consegnati dal nostro corriere

</h3>        
            <p>Si tratta dei colli che non sono stati recapitati al destinatario finale per i motivi seguenti: destinatario sconosciuto, non reclamato, rifiutato, danneggiamento durante il trasporto, manomissione...
</p>

          <h4 class="form-title">  3.1 : Causa di restituzione del collo: destinatario sconosciuto o anomalia indirizzo
</h4>
...
Tutti i collegamenti ipertestuali che rinviano al sito di CALZAFACILE.IT e che utilizzano in particolare le tecniche del framing, deep-linking, in-line linking o tecniche di altro tipo di collegamento diretto sono tassativamente e formalmente vietati. Senza eccezioni, tutti i collegamenti, seppur tacitamente autorizzati, dovranno essere ritirati su richiesta di CALZAFACILE.IT.
            ...
            <p>CALZAFACILE.IT, per esigenze di servizio, si riserva il diritto di raccogliere i dati nominativi relativi agli utenti del sito, in particolare attraverso il "cookie" descritto nell'articolo 8. In questo senso, il sito CALZAFACILE.IT è registrato presso il CNIL con il numero : 1182432. Inoltre, CALZAFACILE.IT si riserva il diritto di cessione, a fini commerciali, dei dati raccolti nel proprio sito.
